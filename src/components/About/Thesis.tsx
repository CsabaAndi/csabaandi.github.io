    ...
    return (
        <section id='sect_xy_thesis' className='p-4 pt-12 md:p-8 md:pt-12'>
            ...
            <div className='grid grid-cols-6 sm:auto-cols-fr sm:grid-flow-col lg:gap-8'>
                <div className='flex flex-col col-start-2 col-end-6 items-center justify-center space-y-2 rounded-xl border-none border-green-900 bg-stone-800 px-2 py-4 shadow-xl shadow-black/30 sm:p-6'>
                    ...
                    <div className='grid grid-cols-8 grid-rows-2 gap-2 sm:auto-cols-fr sm:grid-flow-col lg:gap-2'> 
                        <div className='flex-col row-start-2 items-center justify-center space-y-2 rounded-xl border-none border-green-900 bg-stone-800 px-2 py-4 shadow-xl shadow-black/30 sm:p-6'>                  
                            <GithubIcon size_min={16} size_standard={32}></GithubIcon>                          
                        </div>
                        <div className='flex-col col-span-7 row-span-2 items-center justify-center space-y-2 rounded-xl border-none border-green-900 bg-stone-800 px-2 py-4 shadow-xl shadow-black/30 sm:p-6'> 
