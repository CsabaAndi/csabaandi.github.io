const ProjectPartBlock: React.FC<{ name: string }> = ({ name }) => (
  <div className='class="flex flex-col items-center justify-center space-y-2 rounded-xl border-none border-green-900 bg-stone-800 px-2 py-4 shadow-xl shadow-black/30 sm:p-6'>
    <h3 className='text-md text-center font-extrabold tracking-tight text-stone-200 sm:text-lg'>{name}</h3>
  </div>
);
...
const OtherPartBlock: React.FC<{}> = ({}) => (
    <div className='grid grid-cols-3 gap-2 sm:auto-cols-fr sm:grid-flow-col lg:gap-2'>                   
      ...
      <h3 className='text-md text-center font-extrabold tracking-tight text-stone-200 sm:text-lg'>
        <svg className="h-10 w-10 align-baseline" fill="currentColor" viewBox="0 0 128 128" width="128" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='class="flex flex-col items-center justify-center space-y-2 rounded-xl border-none border-green-900 bg-stone-800 px-2 py-4 shadow-xl shadow-black/30 sm:p-6'>
        <h3 className='text-md text-center font-extrabold tracking-tight text-stone-200 sm:text-lg'>{/* Ide icocok jönnek majd */}</h3> 
      </div>
      <div className='class="flex flex-col items-center justify-center space-y-2 rounded-xl border-none border-green-900 bg-stone-800 px-2 py-4 shadow-xl shadow-black/30 sm:p-6'>
        <h3 className='text-md text-center font-extrabold tracking-tight text-stone-200 sm:text-lg'>{/* Ide icocok jönnek majd */}</h3> 
      </div>       
