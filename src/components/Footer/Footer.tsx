...
function Footer(){
        return (
          ...
          <div className='flex gap-x-6 sm:gap-x-4 text-stone-200'>
            <a href='https://github.com' target="_blank" rel="noopener noreferrer" title="Github"> {/*ide majd az email icon jön */}
            ...
            <a href='https://hu.linkedin.com' target="_blank" rel="noopener noreferrer" title="LinkedIn">
