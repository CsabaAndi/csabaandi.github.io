...
export function AngularIcon(props: IconSizeProps){
    return (
        <div>
            <div className='flex gap-x-2 sm:gap-x-3 sm:hidden'>
                <a href='https://angular.io/' target="_blank" rel="noopener noreferrer" title="Angular">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width={props.size_min} height={props.size_min} viewBox="0 0 256 272" id="angular"><path fill="#E23237" d="M.1 45.522L125.908.697l129.196 44.028-20.919 166.45-108.277 59.966-106.583-59.169L.1 45.522z"></path><path fill="#B52E31" d="M255.104 44.725L125.908.697v270.444l108.277-59.866 20.919-166.55z"></path><path fill="#FFF" d="M126.107 32.274L47.714 206.693l29.285-.498 15.739-39.347h70.325l17.233 39.845 27.99.498-82.179-174.917zm.2 55.882l26.496 55.383h-49.806l23.31-55.383z"></path></svg>
                </a>
            </div>
            <div className='flex gap-x-2 sm:gap-x-3 hidden sm:flex'>
                <a href='https://angular.io/' target="_blank" rel="noopener noreferrer" title="Angular">
                    {/*License - https://iconscout.com/free-icon/angular-3 | by: Icon Mafia */}
                    <svg xmlns="http://www.w3.org/2000/svg" width={props.size_standard} height={props.size_standard} viewBox="0 0 256 272" id="angular"><path fill="#E23237" d="M.1 45.522L125.908.697l129.196 44.028-20.919 166.45-108.277 59.966-106.583-59.169L.1 45.522z"></path><path fill="#B52E31" d="M255.104 44.725L125.908.697v270.444l108.277-59.866 20.919-166.55z"></path><path fill="#FFF" d="M126.107 32.274L47.714 206.693l29.285-.498 15.739-39.347h70.325l17.233 39.845 27.99.498-82.179-174.917zm.2 55.882l26.496 55.383h-49.806l23.31-55.383z"></path></svg>
                </a>
            </div>
        </div>
    )
